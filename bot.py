...
def safe_send_message(chat_id, text, **kwargs):
    """دالة إرسال آمنة تضمن عدم توقف الكود إذا حظر الطالب البوت"""
    try:
...
def check_subscription(user_id):
    try:
        ...
        return True # السماح في حالة خطأ الوصول للشبكة
...
# ==========================================
# 6. سيرفر الـ Keep-Alive (لاستضافة Render)
# ==========================================
...
# ==========================================
# 7. نظام التنبيهات المجدولة (Cron Jobs)
# ==========================================
def scheduler_loop():
    while True:
        try:
            # التوقيت المحلي لليبيا (UTC+2)
...
def handle_all_messages(message):
    try:
        ...
        # الأوامر الرئيسية
        commands = {
            '📊 معدلي الحالي': lambda: (track_feature(text), safe_send_message(chat_id, '📊 الميزة قيد التطوير.\nاستخدم: 🧮 حاسبة المعدل')),
...
def show_help(chat_id):
    safe_send_message(chat_id, '❓ دليل الاستخدام:\n━━━━━━━━━━━━━━━━━━━━\n🧮 حاسبة المعدل: حساب النقاط والمعدل الفصلية.\n🎯 كم أحتاج: التخطيط للمعدل المستهدف.\n🔄 تحسين مادة: لمعرفة الفرق عند تعويض مادة.\n🏆 ما تقديري: معرفة المكافآت والسلالم الأكاديمية.\n💬 صارحني: تواصل سري مع إدارة القناة.')
